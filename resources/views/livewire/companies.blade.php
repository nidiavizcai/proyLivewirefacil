...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @endif
    <button wire:click="create()" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mt-10">Crear Nueva Empresa</button>
    ...
    <div class="py-10">
        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
            <table class="min-w-full leading-normal">
                <thead>
                    <tr>
                        <th class="px-5 py-3 border-b-5 border-black bg-pink-400 text-left text-xs font-semibold text-black uppercase tracking-wider">
                            {{ __('Título') }}
                        </th>
                        <th class="px-5 py-3 border-b-5 border-black bg-pink-400 text-left text-xs font-semibold text-black uppercase tracking-wider">
                        </th>
                        ...
                        <form>
                            ...
                            <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse bg-gray-200">
                                <span class="flex w-full sm:ml-3 sm:w-auto">
                                    <button wire:click.prevent="store()" type="button" class="inline-flex bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Guardar</button>
                                </span>
                                <span class="mt-3 flex w-full sm:mt-0 sm:w-auto">
                                    <button wire:click="closeModal()" type="button" class="inline-flex bg-red-100 hover:bg-red-500 border border-gray-300 text-black-500 font-bold py-2 px-4 rounded">Eliminar</button>
                                </span>
                            </div>
                        </form>
                    </div>
